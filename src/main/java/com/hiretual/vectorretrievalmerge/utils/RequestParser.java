...
import com.hiretual.vectorretrievalmerge.constants.ResumeField;
...
//            logger.info(parameterStr);
    ...
    public static String getDocUid(JsonNode jsonNode){
        JsonNode basic = jsonNode.get(ResumeField.BASIC);
        String uid=basic.get(ResumeField.UID).asText();
        return uid;
    }
